...
public class CartItem {
    ...
    // ── KEY CHANGE: removed @JsonIgnore so pk IS serialized to JSON ──
    // Without this, the frontend receives {} and cannot read product/user data
    @EmbeddedId
    ...
    public CartItemPK getPk()            { return pk; }
    public void setPk(CartItemPK pk)     { this.pk = pk; }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pk.getUser().getId(), getProduct().getId());
    }
}
